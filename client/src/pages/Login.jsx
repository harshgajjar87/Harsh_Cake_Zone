        ...
        <div className="card border border-violet-100">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input className="input" placeholder="Enter username" autoComplete="username"
            ...
            <div>
              ...
              <div className="relative">
                ...
                <button type="button" className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 hover:text-gray-600 text-sm"
