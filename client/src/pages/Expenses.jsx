...
const CAT_COLORS = {
  ...
  'Raw Materials': 'bg-rose-100 text-rose-700',
...
export default function Expenses() {
  ...
  return (
    <div className="space-y-6">
        ...
        {CATEGORIES.map((cat) => {
          ...
          return (
            <button key={cat} onClick={() => setFilterCat(filterCat === cat ? '' : cat)}
              className={`card text-left transition-all border-2 ${filterCat === cat ? 'border-orange-500' : 'border-transparent'}`}>
      ...
      {/* Add Expense Form */}
      <div className="card">
        <h2 className="font-semibold mb-4 text-orange-700">Add Expense</h2>
            ...
            {editTarget === exp._id ? (
              ...
              <div className="flex items-start justify-between gap-3">
                ...
                <div className="flex items-center gap-2 flex-shrink-0">
                  ...
                  <button className="text-gray-400 hover:text-orange-600 transition-colors" onClick={() => startEdit(exp)} aria-label="Edit">✏️</button>
